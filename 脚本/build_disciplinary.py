...
INITIAL_RULES = [
    ...
    dict(category='滥用组织名义',
         ...
         appeal_body='审裁委员会', appeal_deadline='收到处分决定后7日内',
    ...
    dict(category='泄露成员隐私',
         behavior='泄露其他成员的隐私信息（真实姓名、手机号、家庭住址、照片等），或泄露成员登记的账号找回邮箱、将其与真实身份关联、将其用于账号找回与系统通知以外之目的',
         severity='中度', penalty_type='限制权利',
    ...
    dict(category='妨碍组织运作',
         ...
         deciding_body='会议主持人当场裁量（事后经常任委员会确认），有异议由审裁委员会审理',
    ...
    dict(category='权力滥用',
         ...
         deciding_body='纪律调查委员会调查，审裁委员会审理，全体成员会议通过',
         procedure='纪律调查委员会调查→移送审裁委员会审理→提交全体成员会议→表决（过半数暂停职务，三分之二以上罢免）',
         appeal_body='全体成员会议', appeal_deadline='收到处分决定后14日内',
    ...
    dict(category='权力滥用',
         ...
         deciding_body='纪律调查委员会调查，审裁委员会审理，全体成员会议通过',
         procedure='发现→纪律调查委员会协同资产管理委员会调查→移送审裁委员会审理→报告全会→表决（三分之二以上）',
         appeal_body='全体成员会议', appeal_deadline='收到处分决定后14日内',
         charter_basis='第六十七条、第六十八条',
         notes='经费管理人员负有最高诚信义务'),

    dict(category='权力滥用',
         behavior='组织代表滥用临时决策权，且审裁委员会已裁决其行使不合理',
         severity='重度', penalty_type='限制权利',
         penalty_detail='暂停代表职务（限制其作为代表的一切权利行使）；经全体成员会议表决可罢免',
         penalty_duration='至当届任期结束',
         deciding_body='纪律调查委员会调查，审裁委员会审理，全体成员会议通过',
         procedure='审裁委员会裁决不合理→提交全会→表决（过半数暂停职务，三分之二以上罢免）',
         appeal_body='全体成员会议', appeal_deadline='收到处分决定后14日内',
    ...
    dict(category='违反投票规则',
         ...
         penalty_duration='至少一学期',
         deciding_body='纪律调查委员会调查，审裁委员会审理',
         procedure='纪律调查委员会发现异常→移送审裁委员会审理→审裁委员会作出裁决；异常投票由审裁委员会裁决撤销并重算',
         appeal_body='全体成员会议', appeal_deadline='收到处分决定后14日内',
         charter_basis='第五十五条第六项',
         notes='审裁委员会可先裁决撤销异常投票，再追责'),
    ...
    dict(category='违反投票规则',
         ...
         deciding_body='纪律调查委员会调查，审裁委员会审理',
         procedure='发现→纪律调查委员会调查→移送审裁委员会审理→宣布表决无效→通知常任委员会记录',
         appeal_body='常任委员会', appeal_deadline='收到处分决定后7日内',
    ...
    dict(category='其他严重违规',
         behavior='其他虽未在《处罚》规则中列明，但经纪律调查委员会调查、审裁委员会认定严重违反本章程的行为',
         severity='中度', penalty_type='限制权利',
         penalty_detail='根据行为性质和后果裁量', penalty_duration='不超过一学期',
         deciding_body='纪律调查委员会调查，审裁委员会审理',
         procedure='纪律调查委员会调查→移送审裁委员会审理→听取申辩→作出裁决→报全体成员会议通过',
         appeal_body='审裁委员会', appeal_deadline='收到处分决定后7日内',
         charter_basis='第十八条',
         notes='兜底条款，不得滥用'),
]
